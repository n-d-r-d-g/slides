...
export function ChangeCaseSlide() {
  return (
    <Slide>
      <Heading>{"VSCode: Change Case"}</Heading>
      ...
      <p className="text-4xl text-center mt-6">Then type: <span className="italic font-bold">Transform to...</span></p>
    </Slide>
  );
}