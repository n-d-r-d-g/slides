...
export function SortImportsSlide() {
  return (
    <Slide>
      <Heading>{"VSCode: Organize Imports"}</Heading>
      ...
      <p className="text-4xl text-center mt-6">Then type: <span className="italic font-bold">Organize Imports</span></p>
    </Slide>
  );
}